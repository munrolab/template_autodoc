...
# to view bulid of docs, run 'python -m http.server 8000' in terminal from docs directory
# open in web browser: http://localhost:8000/_build/html/index.html
...
latex_documents = [
  (master_doc, 'documentation.tex', 'Blobs documentation',
   'Baixue Yao', 'manual'),
]
...
man_pages = [
    (master_doc, 'blobs', 'Blobs Documentation',
     [author], 1)
]
